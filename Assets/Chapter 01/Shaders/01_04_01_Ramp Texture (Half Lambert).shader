Shader "PacktPub.com/Kenny Lammers/Cook Book Shaders/Ramp Texture (Half Lambert)" {
	Properties {
		...
		*/
		...
		inline float4 LightingRampHalfLambert(SurfaceOutput s, fixed3 lightDir, fixed atten) {
			...
			*/
			...
			Here we already calculate Half Lambert Light so we will use it to get fake UV of Mesh
			*/
